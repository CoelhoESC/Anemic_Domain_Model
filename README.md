- Um modelo de dominio, onde os objetivos que representam as entidades, contêm pouca ou nenhuma lógica de negócio (validação, cálculos, regras de negócios, etc).
